...
export function setMockHeader(_key: MockHeaderKey, _value: string | undefined): void {}
...
export function getMockStatus(): string { return 'No mock headers active (using real limits)' }
export function clearMockHeaders(): void {}
export function applyMockHeaders(headers: globalThis.Headers): globalThis.Headers { return headers }
...
export function setMockSubscriptionType(_subscriptionType: SubscriptionType | null): void {}
export function getMockSubscriptionType(): SubscriptionType | null { return null }
...
export function checkMockFastModeRateLimit(_isFastModeActive?: boolean): null { return null }
